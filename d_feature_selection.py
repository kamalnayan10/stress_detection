...
def calculate_features(functions_to_apply, column_names, downsample_frequency="10S", time_range=(3, 9), path="D:/MLdata/stress-recognition-in-automobile-drivers-1.0.0/csv_files/preprocessed_data", folder_name="final_data"):
    all_drives = []
