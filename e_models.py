...
DATASET_PATH = "D:/MLdata/stress-recognition-in-automobile-drivers-1.0.0/csv_files/preprocessed_data/final_data/all_drives.csv"
...
if __name__ == "__main__":
    main(feature_selection="lda" , classifier="loop" , undersample=True , shuffle = True)